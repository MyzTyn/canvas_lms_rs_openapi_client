# RubricsCreateRequestRubricAssociation
...
**purpose** | Option<**String**> | [String] Whether or not the association is for grading (and thus linked to an assignment) or if it's to indicate the rubric should appear in its context | [optional]
