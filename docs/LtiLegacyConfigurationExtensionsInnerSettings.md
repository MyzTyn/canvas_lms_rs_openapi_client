# LtiLegacyConfigurationExtensionsInnerSettings

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**text** | Option<**serde_json::Value**> | The text of the link to the tool (if applicable). | [optional]
...
**display_type** | Option<**DisplayType**> | The Canvas layout to use when launching the tool. See the Navigation Placement docs. (enum: default, full_width, full_width_in_context, full_width_with_nav, in_nav_context, borderless) | [optional]
...
**placements** | [**Vec<models::LtiPlacement>**](LtiPlacement.md) | List of placements configured by the tool | 
