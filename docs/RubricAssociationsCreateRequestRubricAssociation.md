...
------------ | ------------- | ------------- | -------------
**rubric_id** | Option<**i32**> | [Integer] The id of the Rubric | [optional]
...
**title** | Option<**String**> | [String] The name of the object this rubric is associated with | [optional]
...
**bookmarked** | Option<**bool**> | [Boolean] Whether or not the associated rubric appears in its context | [optional]
