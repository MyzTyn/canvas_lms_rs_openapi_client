...
------------ | ------------- | ------------- | -------------
**name** | Option<**String**> | [String] The name of the module | [optional]
**unlock_at** | Option<**String**> | [DateTime] The date the module will unlock | [optional]
**position** | Option<**i32**> | [Integer] The position of the module in the course (1-based) | [optional]
...
**published** | Option<**bool**> | [Boolean] Whether the module is published and visible to students | [optional]
