...
------------ | ------------- | ------------- | -------------
**title** | Option<**String**> | The title for the Grading Standard | [optional]
...
**grading_scheme_entry_left_square_bracket_right_square_bracket_left_square_bracket_name_right_square_bracket** | Option<**String**> | [String] The name for an entry value within a GradingStandard that describes the range of the value e.g. A- | [optional]
