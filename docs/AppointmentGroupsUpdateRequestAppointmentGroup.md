...
**title** | Option<**String**> | [String] Short title for the appointment group. | [optional]
...
**allow_observer_signup** | Option<**bool**> | [Boolean] Whether observer users can sign-up for an appointment. | [optional]
