...
pub struct SectionsUpdateRequest {
    ...
    pub course_section: Option<Box<models::SectionsUpdateRequestCourseSection>>,
}

impl SectionsUpdateRequest {
    pub fn new() -> SectionsUpdateRequest {
