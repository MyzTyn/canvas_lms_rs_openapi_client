...
pub struct AssignmentGroupsApiUpdateRequest {
...
impl AssignmentGroupsApiUpdateRequest {
    pub fn new() -> AssignmentGroupsApiUpdateRequest {
        AssignmentGroupsApiUpdateRequest {
            name: None,
            position: None,
            group_weight: None,
            sis_source_id: None,
