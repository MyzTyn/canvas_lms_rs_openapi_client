...
pub struct GroupCategoriesCreateForAccountsRequest {
...
impl GroupCategoriesCreateForAccountsRequest {
    pub fn new(name: String) -> GroupCategoriesCreateForAccountsRequest {
