...
/// struct for typed errors of method [`authentication_providers_create`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum AuthenticationProvidersCreateError {
    DefaultResponse(String),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`authentication_providers_destroy`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum AuthenticationProvidersDestroyError {
    DefaultResponse(),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`authentication_providers_index`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum AuthenticationProvidersIndexError {
    DefaultResponse(models::AuthenticationProvider),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`authentication_providers_restore`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum AuthenticationProvidersRestoreError {
    DefaultResponse(String),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`authentication_providers_show`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum AuthenticationProvidersShowError {
    DefaultResponse(String),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`authentication_providers_show_sso_settings`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum AuthenticationProvidersShowSsoSettingsError {
    DefaultResponse(String),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`authentication_providers_update`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum AuthenticationProvidersUpdateError {
    DefaultResponse(String),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`authentication_providers_update_sso_settings`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum AuthenticationProvidersUpdateSsoSettingsError {
    DefaultResponse(String),
    UnknownValue(serde_json::Value),
}
...
pub async fn authentication_providers_create(configuration: &configuration::Configuration, account_id: &str) -> Result<String, Error<AuthenticationProvidersCreateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_account_id = account_id;

    let uri_str = format!("{}/accounts/{account_id}/authentication_providers", configuration.base_path, account_id=crate::apis::urlencode(p_path_account_id));
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<AuthenticationProvidersCreateError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// Delete the config
pub async fn authentication_providers_destroy(configuration: &configuration::Configuration, account_id: &str, id: &str) -> Result<(), Error<AuthenticationProvidersDestroyError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_account_id = account_id;
    let p_path_id = id;

    let uri_str = format!("{}/accounts/{account_id}/authentication_providers/{id}", configuration.base_path, account_id=crate::apis::urlencode(p_path_account_id), id=crate::apis::urlencode(p_path_id));
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<AuthenticationProvidersDestroyError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// Returns a paginated list of authentication providers
pub async fn authentication_providers_index(configuration: &configuration::Configuration, account_id: &str) -> Result<models::AuthenticationProvider, Error<AuthenticationProvidersIndexError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_account_id = account_id;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::AuthenticationProvider`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::AuthenticationProvider`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<AuthenticationProvidersIndexError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn authentication_providers_restore(configuration: &configuration::Configuration, account_id: &str, id: &str) -> Result<String, Error<AuthenticationProvidersRestoreError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_account_id = account_id;
    let p_path_id = id;

    let uri_str = format!("{}/accounts/{account_id}/authentication_providers/{id}/restore", configuration.base_path, account_id=crate::apis::urlencode(p_path_account_id), id=crate::apis::urlencode(p_path_id));
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<AuthenticationProvidersRestoreError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// Get the specified authentication provider
pub async fn authentication_providers_show(configuration: &configuration::Configuration, account_id: &str, id: &str) -> Result<String, Error<AuthenticationProvidersShowError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_account_id = account_id;
    let p_path_id = id;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<AuthenticationProvidersShowError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn authentication_providers_show_sso_settings(configuration: &configuration::Configuration, account_id: &str) -> Result<String, Error<AuthenticationProvidersShowSsoSettingsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_account_id = account_id;

    let uri_str = format!("{}/accounts/{account_id}/sso_settings", configuration.base_path, account_id=crate::apis::urlencode(p_path_account_id));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<AuthenticationProvidersShowSsoSettingsError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn authentication_providers_update(configuration: &configuration::Configuration, account_id: &str, id: &str) -> Result<String, Error<AuthenticationProvidersUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_account_id = account_id;
    let p_path_id = id;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<AuthenticationProvidersUpdateError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn authentication_providers_update_sso_settings(configuration: &configuration::Configuration, account_id: &str) -> Result<String, Error<AuthenticationProvidersUpdateSsoSettingsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_account_id = account_id;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<AuthenticationProvidersUpdateSsoSettingsError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
